...
def main():
    ...
    with PyriServiceNodeSetup("tech.pyri.vision.template_matching", 55919, \
        ...
        service_node_setup.register_service("vision_template_matching","tech.pyri.vision.template_matching.VisionTemplateMatchingService",VisionTemplateMatching_inst)
